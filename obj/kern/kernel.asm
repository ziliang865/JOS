...
f0100a30:	b8 2e 71 10 f0       	mov    $0xf010712e,%eax
...
f0100a50:	e8 91 f6 ff ff       	call   f01000e6 <_panic>
	...
	// String table validity checks
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
f0100a55:	80 3d 2d 71 10 f0 00 	cmpb   $0x0,0xf010712d
...
f0100ae2:	b8 2e 71 10 f0       	mov    $0xf010712e,%eax
...
f0100b54:	b8 2e 71 10 f0       	mov    $0xf010712e,%eax
